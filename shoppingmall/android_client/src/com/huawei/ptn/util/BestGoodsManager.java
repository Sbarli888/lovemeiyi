...
public class BestGoodsManager extends Activity {
	
	private static final String TAG = BestGoodsManager.class.getSimpleName();
	...
	public BestGoodsManager(Context context) {
		mContext = context;
	}
	...
	private void Notify(){
		Log.d(TAG, "BestGoodsManager::notify()");
		notifyObservers();
	}
