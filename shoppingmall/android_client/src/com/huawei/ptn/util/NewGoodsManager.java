...
public class NewGoodsManager extends Activity {
	
	private static final String TAG = NewGoodsManager.class.getSimpleName();
	...
	public NewGoodsManager(Context context) {
		mContext = context;
	}
	...
	private void Notify(){
		Log.d(TAG, "NewGoodsManager::notify()");
		notifyObservers();
	}
